...
public class MarshMallowPermissionActy extends AppCompatActivity {
    ...
    private void permissionGranted() {
        MarshMallowBusProvider.getInstance().post(new MarshMallowPermissionEvent(true, null));
        finish();
        overridePendingTransition(0, 0);
    }

    private void permissionDenied(ArrayList<String> deniedpermissions) {
        MarshMallowBusProvider.getInstance().post(new MarshMallowPermissionEvent(false, deniedpermissions));
        finish();
        overridePendingTransition(0, 0);
    }
            ...
            builder.setPositiveButton(settingButtonText, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    try {
                        ...
                        e.printStackTrace();
                        MarshMallowLogUtils.e(e.toString());
